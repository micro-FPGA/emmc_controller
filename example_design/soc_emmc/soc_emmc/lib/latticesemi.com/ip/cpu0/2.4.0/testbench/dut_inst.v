    cpu0 u_cpu0(.clk_system_i(clk_system_i),
        ...
        .dbus_cmd_payload_exclusive(dbus_cmd_payload_exclusive),
        ...
        .dbus_rsp_payload_exclusive(dbus_rsp_payload_exclusive),
        .dbus_inv_valid(dbus_inv_valid),
        .dbus_inv_ready(dbus_inv_ready),
        .dbus_inv_payload_last(dbus_inv_payload_last),
        .dbus_inv_payload_fragment_enable(dbus_inv_payload_fragment_enable),
        .dbus_inv_payload_fragment_address(dbus_inv_payload_fragment_address),
        .dbus_ack_valid(dbus_ack_valid),
        .dbus_ack_ready(dbus_ack_ready),
        .dbus_ack_payload_last(dbus_ack_payload_last),
        .dbus_ack_payload_fragment_hit(dbus_ack_payload_fragment_hit));
